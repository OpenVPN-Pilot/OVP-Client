...
| A shared library | the file wherever it was put, and in `%LOCALAPPDATA%\OpenVpnPilot\library\` what this machine last synchronised with it, encrypted like the file |
